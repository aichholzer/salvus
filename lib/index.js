...
const salvus = {
    ...
    noto: function (elementum) {
        ...
        elementum.forEach(elementi => {
            ...
            let multiSubstantia = salvus.extraho(elementi),
                semita;
        ...
        for (let bona in sui) {
            if (sui.hasOwnProperty(bona)) {
                ...
                const estAcies = Array.isArray(sui[bona]),
                    ...
                    estObietum = !estAcies && sui[bona] && typeof sui[bona] === 'object',
                    inanisObietum = estObietum && Object.keys(sui[bona]).length === 0;
